...
const Description = () => {
    ...
    return(
                ...
                <CardContent>
                    ...
                    <Grid item xs={5}>
                        <Box display="flex" justifyContent="center" height="200px" py={2}>
                            <img src={require(`../../Assets/Candidates/${itemName[id]["img"]}`)} alt="profile" />
                        </Box>
                        <Typography variant="subtitle2" className="cardHeader" fontWeight="bold" height="100%" >
                            Candidate {parseInt(id)+1}
                        </Typography>
                    </Grid>
                    <Grid item xs={6}>
                            ...
                            return(
                                <Grid container gap={2} key={key} mt={1}>
                                    <Grid item xs={3} display="flex" justifyContent="flex-end">
                                        <Typography variant="subtitle2" fontWeight="bold" color="#C59D5F">{key}</Typography>
                                    </Grid>
                                    <Grid item xs={8}>
        ...
        <Box display="flex" flexDirection="column" alignItems="center" mt={5}>
            <Typography variant="subtitle2" fontWeight="bold" my={2} color="#264653">CANDIDATES</Typography>
            <Pagination 
                ...
                sx={{color:"#264653", 
                    ...
                    ".css-lqq3n7-MuiButtonBase-root-MuiPaginationItem-root.Mui-selected":{
                        color: "#FFFFFF", backgroundColor:"#264653"
                    }
                }}
            />
        </Box>
